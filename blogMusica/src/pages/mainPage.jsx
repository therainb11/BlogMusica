      ...
      <main>
        ...
        <div className={styles.noticia}>
          ...
          <div className={styles.parrafoNoticia}>
            ...
            <p>
              ...
              saldrá el 12 de septiembre de 2025. Este álbum cierra la historia
              conceptual que comenzó con Blurryface en 2015 y continuó en Trench
              y Clancy. <br />
              Tyler lo describió como:
            </p>
            <p className={styles.citadoPersona}>
              “Breach me quitó todo lo que tenía… pero al mirar estos archivos
              WAV terminados, me doy cuenta de lo poco que significan hasta que
              llegan a ustedes”.
            </p>
            <p>
        ...
        <div className={styles.noticia}>
          <div className={styles.parrafoNoticia}>
            ...
            <p className={styles.citadoPersona}>
              “Es un estado mental en el que tengo que entrar y que simplemente
              ya no deseo. Siento que viene con tantas cosas…”
            </p>
            <p>
              Después de más de 15 años como The Weeknd, con más de 75 millones
              de discos vendidos, 4 premios Grammy y múltiples giras mundiales,
              Tesfaye siente que ha dominado esa etapa y quiere cerrar el ciclo
              en su mejor momento.
            </p>
        ...
        <div className={styles.noticia}>
          ...
          <div className={styles.parrafoNoticia}>
            ...
            <p>
              La presentación se dio el domingo 3 de agosto en Chicago, durante
              el cierre de Lollapalooza. Sabrina, en plena gira Short n’ Sweet,
              decidió invitar a Earth, Wind & Fire para interpretar juntos dos
              clásicos: <br />
              <ul>
                <li>“Let’s Groove”</li>
                <li>“September”</li>
